...
# Fields to anonymize. Generated from selected entries obtained with 'tdms_manage.pl -xl' and saved in 'anonymize_me.txt'
...
our %AnonymizedFields = (
    all => {
        ...
        acpr_prtprh => [ qw(pnr pnr12 namn sp_coadress sp_foadress sp_gatuadress sp_postnr sp_postort utl_landkod utl_postkod utl_postort utl_land mnamn enamn fnamn fbf_coadress fbf_foadress fbf_gatuadress fbf_postnr fbf_postort rel_pnr) ],
    ...
    pnum => {
        ...
        acpr_prtprh => [ qw(pnr pnr12 rel_pnr) ],
        actx_tax01 => [ qw(pnr pnr12) ],
        actx_tax02 => [ qw(pnr pnr12) ],
    },
    pname => {
    ...
    orgname => {
        full => {
            ...
            acib_acitkcn => [ qw(kcn_namn) ],
            acib_acitmin => [ qw(min_namn) ],
        },
        abbr => {
